  ...
  const playlists = [
    {
      ...
      description: 'As músicas mais tocadas do momento',
    },
    {
      id: 2,
      title: 'RapCaviar',
      description: 'Os maiores hits do hip hop',
    },
    {
      id: 3,
      title: 'All Out 2010s',
      description: 'As maiores músicas da década de 2010',
    },
    {
      id: 4,
      title: 'Rock Classics',
      description: 'Clássicos do rock que nunca saem de moda',
    },
    {
      id: 5,
      title: 'Chill Hits',
      description: 'Relaxe com estas músicas calmas',
    },
    {
      id: 6,
      title: 'Viva Latino',
      description: 'Os melhores hits latinos de hoje',
    },
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.greeting}>Boa tarde</h1>
        
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>Playlists populares</h2>
          <div className={styles.grid}>
            {playlists.map((playlist) => (
              <Card
                ...
                onClick={() => console.log(`Clicked on ${playlist.title}`)}
              />
            ))}
          </div>
        </section>
